...
_0x0:
	.DB  0x76,0x6F,0x6C,0x74,0x61,0x67,0x65,0x3D
...
;#define ADC_VREF_TYPE ((0<<REFS1) | (0<<REFS0) | (0<<ADLAR))   /* «ÌÃ«œ „Ì ‘Ê‰œ adc òÂ  Ê”ÿ ŒÊœ òœÊÌé‰ »« ›⁄«·”«“Ì adc « ...
...
; 0000 001A PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	...
	OUT  0x15,R30
; 0000 001B 
; 0000 001C ADMUX=ADC_VREF_TYPE;              /* òÂ »«  ÊÃÂ »Â  ‰ŸÌ„«  „« œ— „ÕÌÿ òœÊÌ“«—œ «ÌÃ«œ „Ì ‘Ê‰œ adc «“ Œÿ 28  « 30 —ÃÌ” —Â« ...
	OUT  0x7,R30
...
_0x6:
; 0000 0023       {
; 0000 0024       i=read_adc(0);                // i ŒÊ«‰œ‰ ⁄œœÌ »Ì‰ 0  « 1023 òÂ ‰‘«‰ œÂ‰œÂ „ﬁœ«— Ê· «é «‰«·Êê —ÊÌ «‰ ÅÌ‰ „Ìò—Ê «”  ...
	LDI  R26,LOW(0)
	RCALL _read_adc
	CLR  R22
	CLR  R23
	CALL __CDF1
	__PUTD1S 24
; 0000 0025       volt=(i*5)/1023 ;             // œ” Ê— —Ê»—Ê ⁄œœ ŒÊ«‰œÂ ‘œÂ »Ì‰ 0  « 1023 —« œ— »«“Â Ì 0  « 5  »œÌ· „Ì ò‰œ //
	__GETD2S 24
	__GETD1N 0x40A00000
	CALL __MULF12
	MOVW R26,R30
	...
	CALL __DIVF21
	__PUTD1S 20
; 0000 0026        /* «“ «‰Ã«ÌÌ òÂ »«“Â Ì «‰œ«“Â êÌ—Ì Ê· «é „« »Ì‘ «“ 0  « 5 Ê·  «”  „« »« «” ›«œÂ «“  ﬁ”Ì„ „ﬁ«Ê„ Ì Ê· «é —« ò«Â‘ œ« ...
; 0000 0027       voltage=(volt*10)+volt ;         /*ÿ»ﬁ  Ê÷ÌÕ »«·« „« Ê· «éÌ —« òÂ ò«Â‘ œ«œÂ «Ì„ »« «” ›«œÂ «“ œ” Ê— —Ê»—Ê œÊ»«—Â » ...
	__GETD2S 20
	CALL SUBOPT_0x0
	__GETD2S 20
	CALL __ADDF12
	CALL SUBOPT_0x1
; 0000 0028       sprintf(lcd,"voltage=%2.2f",voltage);        // LCD »—«Ì ‰„«Ì‘ —ÊÌ lcd  »œÌ· „ﬁ«œÌ— Ê· «é »Â —‘ Â «Ì «“ ò«—«ò — Ê  ...
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
...
; 0000 0029       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 002A       lcd_puts(lcd);             // –ŒÌ—Â ‘œÂ «‰œ lcd ‰„«Ì‘ „ﬁ«œÌ— Ê· «é òÂ »Â ’Ê—  ò«—«ò — œ— „ €Ì— //
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 002B       lcd_gotoxy(13,0);
	LDI  R30,LOW(13)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 002C       lcd_putsf("V");            // »⁄œ «“ Ê· «é LCD —ÊÌ V ‰Ê‘ ‰ ò«—«ò — //
	__POINTW2FN _0x0,14
	RCALL _lcd_putsf
